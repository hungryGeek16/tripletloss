...
#        print(self._triplet)
        ...
        while len(sample) < self._triplet*3:          
            ...
            if archor_personname == personname:
                ...
                if index == 0:
                    ...
                    index = rand - 1
                if index <= len(self.data_container._sample_person)-1:                       
                    personname = list(self.data_container._sample_person.keys())[index]
        ...
        print("Sample in batch ",count,":",sample)    
            #print("With Negative",sample)     
    ...
    def _get_image_blob(self,sample):
        ...
        for i in range(self._batch_size):
            ...
            #print(sample[i])
            #print(config.IMAGEPATH+sample[i])
            #print(im)
...
if __name__ == '__main__':
    ...
    for i in range(2):
#        print(str(i),np.shape(blob["data"]),blob["labels"])
        blob = test._get_next_minibatch()#,blob 
