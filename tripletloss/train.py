...
class SolverWrapper(object):
    ...
    def train_model(self, max_iters):
        ...
        while self.solver.iter < max_iters:
            timer.tic()
            self.solver.step(1)	  
            print('embeddings:',sorted(self.solver.net.params['embeddings'][0].data[...])[-1])
...
if __name__ == '__main__':
    """Train network."""
    solver_prototxt = '/home/rahul/trip/solver.prototxt'
    output_dir = '/home/rahul/trip/models/'
    pretrained_model = '/home/rahul/trip/models/inc_res.caffemodel'
    #pretrained_model = None
